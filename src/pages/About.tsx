...
const PremiumIcon = ({ icon: Icon }: { icon: React.ElementType }) => (
  <div className="mb-6 relative inline-block group-hover:scale-110 transition-transform duration-300">
    ...
    <Icon className="w-12 h-12 text-slate-700 dark:text-muted-foreground relative z-10 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300" />
  </div>
);
      ...
      <main className="flex-1">
        ...
        <section className="py-0">
          <div className="grid md:grid-cols-2">
            {/* Mission */}
            <div className="bg-background dark:bg-[#080d1a] border-r border-border text-foreground p-12 lg:p-20 flex flex-col justify-center items-center text-center relative overflow-hidden group">
              ...
              <AnimatedSection animation="fade-right">
                <div className="relative z-10">
                  <div className="w-20 h-20 rounded-full bg-card dark:bg-card/80 flex items-center justify-center mx-auto mb-6 group-hover:bg-accent dark:group-hover:bg-blue-600 transition-colors duration-500">
            ...
            {/* Vision */}
            <div className="bg-blue-900 dark:bg-[#0a0f1c] text-foreground p-12 lg:p-20 flex flex-col justify-center items-center text-center relative overflow-hidden group">
              ...
              <AnimatedSection animation="fade-left" delay={1}>
                <div className="relative z-10">
                  <div className="w-20 h-20 rounded-full bg-blue-800 dark:bg-blue-900/80 flex items-center justify-center mx-auto mb-6 group-hover:bg-white dark:group-hover:bg-blue-500 transition-colors duration-500">
                    <Eye className="w-10 h-10 text-blue-200 group-hover:text-blue-900 dark:group-hover:text-foreground" />
                  </div>
                  <h3 className="text-2xl font-heading font-bold mb-6 tracking-wide">OUR VISION</h3>
                  <p className="text-blue-100 dark:text-muted-foreground leading-relaxed text-lg max-w-md mx-auto">
            ...
            <AnimatedSection animation="fade-up" className="mb-16">
              <div className="flex flex-col items-center text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 dark:bg-foreground/5 border border-slate-200 dark:border-border mb-6">
                  ...
                  <span className="text-xs font-bold uppercase tracking-widest text-slate-700 dark:text-muted-foreground">Core Principles</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-heading font-extrabold text-slate-900 dark:text-foreground mb-6">Our Values</h2>
                ...
                >
                  ...
                  <div className="relative h-full bg-card/80 backdrop-blur-xl rounded-[23px] p-8 md:p-10 flex flex-col md:flex-row gap-6 items-start z-10 border border-border transition-colors duration-500">
                    ...
                    <div>
                      ...
                      <p className="text-base text-slate-600 dark:text-muted-foreground leading-relaxed font-medium">
                        {item.desc}
                      </p>
                    </div>
                  </div>
                ...
                <AnimatedSection key={idx} animation="scale-in" delay={idx * 0.1}>
                  <div className="group bg-card p-6 rounded-xl border border-border flex items-center gap-4 hover:shadow-lg hover:border-accent/30 hover:bg-card/80 transition-all duration-300 cursor-default">
                    <div className="p-3 bg-white dark:bg-blue-500/10 rounded-lg shadow-sm group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-foreground transition-colors">
                      <Layers className="w-6 h-6 text-slate-700 dark:text-blue-400 group-hover:text-foreground" />
                    </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-5">
                <AnimatedSection animation="fade-right">
                  ...
                  <h2 className="text-5xl lg:text-6xl font-heading font-extrabold text-slate-900 dark:text-foreground leading-tight mb-8">
                    Engineering <br />
                  ...
                  <p className="text-slate-600 dark:text-muted-foreground leading-relaxed text-lg lg:text-xl font-light mb-10 border-l-2 border-blue-400/50 dark:border-accent/50 pl-6">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <div className="flex items-center gap-3 bg-white/60 dark:bg-foreground/5 backdrop-blur-sm border border-slate-200 dark:border-border rounded-full px-5 py-2.5">
                      <ShieldCheck className="w-5 h-5 text-blue-600 dark:text-accent" />
                      <span className="text-slate-800 dark:text-foreground text-sm font-medium tracking-wide">Zero Defects Target</span>
                    </div>
                    <div className="flex items-center gap-3 bg-white/60 dark:bg-foreground/5 backdrop-blur-sm border border-slate-200 dark:border-border rounded-full px-5 py-2.5">
                      <Cog className="w-5 h-5 text-blue-600 dark:text-accent" />
                      <span className="text-slate-800 dark:text-foreground text-sm font-medium tracking-wide">Precision Engineered</span>
                    </div>
                  </div>
                </AnimatedSection>
              </div>
                  ...
                  <div className="relative p-1 rounded-3xl bg-gradient-to-br from-blue-300/50 via-cyan-300/20 dark:from-accent/50 dark:via-blue-500/20 to-transparent shadow-xl dark:shadow-2xl overflow-hidden group">
                    ...
                    <div className="bg-white/80 dark:bg-[#0f172a]/90 backdrop-blur-xl rounded-[23px] p-8 lg:p-12 relative h-full flex flex-col justify-center border border-border dark:border-border">
                      ...
                      <div className="relative z-10 w-full mb-8">
                        ...
                        <p className="text-slate-800 dark:text-foreground font-medium text-2xl lg:text-3xl leading-snug lg:leading-relaxed">
                      ...
                      <div className="grid sm:grid-cols-3 gap-4 mt-4 relative z-10">
                        {[
                          ...
                          <div key={idx} className="bg-slate-50/80 dark:bg-foreground/5 border border-slate-200 dark:border-border rounded-2xl p-5 hover:bg-white dark:hover:bg-foreground/5 hover:shadow-md dark:hover:shadow-none transition-all flex flex-col items-center text-center group/pillar cursor-default backdrop-blur-md">
                            ...
                            <h4 className="text-slate-800 dark:text-foreground font-bold tracking-wide mb-1 flex items-center gap-1">{pillar.title}</h4>
                            <span className="text-slate-500 dark:text-muted-foreground text-xs uppercase tracking-wider">{pillar.desc}</span>
                          </div>
                        ))}
                      </div>
              ...
              {[
                ...
                <Card key={idx} className="group text-center h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-border bg-card overflow-hidden relative backdrop-blur-sm">
                  ...
                  <CardContent className="pt-8 pb-8 flex flex-col items-center justify-center h-full">
                    <div className="mb-4 text-muted-foreground dark:text-slate-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300 transform group-hover:scale-110">
                      <industry.icon className="w-10 h-10" />
                    </div>
                    <h3 className="font-bold text-slate-800 dark:text-foreground group-hover:text-slate-900 dark:group-hover:text-foreground transition-colors">{industry.name}</h3>
                  </CardContent>
                </Card>
              ))}
            </StaggerGrid>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="bg-card rounded-3xl p-8 md:p-12 border border-border shadow-sm flex flex-col md:flex-row items-center gap-8 lg:gap-12 backdrop-blur-sm">
              <div className="md:w-1/3 flex justify-center">
                <div className="w-32 h-32 bg-white dark:bg-[#080d1a] rounded-full flex items-center justify-center shadow-lg dark:shadow-cyan-900/20 border-4 border-slate-100 dark:border-border">
                  <div className="text-center">
                    <span className="block text-3xl font-bold text-slate-900 dark:text-foreground">25+</span>
                    <span className="text-xs uppercase font-bold text-slate-500 dark:text-muted-foreground">Years</span>
                  </div>
                </div>
              </div>
              <div className="md:w-2/3 text-center md:text-left">
                <h3 className="text-2xl font-heading font-bold mb-4 text-slate-900 dark:text-foreground">Why Choose Us?</h3>
                <p className="text-lg text-slate-600 dark:text-muted-foreground font-medium mb-4 leading-relaxed">
        ...
        <section className="py-24 bg-gradient-to-b from-muted to-background text-center transition-colors duration-500 border-t border-border">
          <div className="container mx-auto px-4">
            <AnimatedSection animation="fade-up">
              <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6 text-slate-900 dark:text-foreground">Ready to Discuss Your Requirements?</h2>
              <p className="text-slate-600 dark:text-muted-foreground max-w-2xl mx-auto mb-10 text-lg">
                Contact us today for stable manufacturing and predictable supply.
              </p>
              <Link to="/contact">
                <MagneticButton className="bg-blue-600 dark:bg-accent hover:bg-blue-700 dark:hover:bg-accent/90 text-foreground px-10 py-4 rounded-full text-lg shadow-lg dark:shadow-[0_0_30px_rgba(59,130,246,0.2)] transition-colors">
                  Get in Touch
                </MagneticButton>
              </Link>
            </AnimatedSection>
