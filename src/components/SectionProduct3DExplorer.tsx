...
const MATERIALS = {
    steel: { name: "Stainless Steel", color: "#e2e8f0", roughness: 0.15, metalness: 0.9, envMapIntensity: 1 },
    black: { name: "Black Oxide", color: "#1e293b", roughness: 0.7, metalness: 0.4, envMapIntensity: 0.5 },
    metal: { name: "Galvanized", color: "#94a3b8", roughness: 0.4, metalness: 0.6, envMapIntensity: 0.8 }
};

// View Options for the Gallery
// View Options for the Gallery
const VIEW_OPTIONS = [
    { id: 'bolts', name: 'Industrial Bolts', image: '/sangam_fasteners/images/ui/bolt-nut.png', description: 'High-tensile strength bolts for structural integrity.' },
    { id: 'screws', name: 'Precision Screws', image: '/sangam_fasteners/images/ui/screws.png', description: 'Engineered for specific torque and load requirements.' },
    { id: 'spanners', name: 'Tools & Spanners', image: '/sangam_fasteners/images/ui/spanner.png', description: 'Durable chrome-vanadium tools for maintenance.' },
    { id: 'washers', name: 'Nuts & Washers', image: '/sangam_fasteners/images/ui/washers.png', description: 'Essential components for vibration resistance.' }
];
        ...
        <section className="py-10 bg-slate-50 relative overflow-hidden">
            ...
            <div className="container px-4 mx-auto">
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
                    ...
                    {/* LEFT: 3D Viewport (Seamless) */}
                    <div className="w-full max-w-[500px] aspect-square relative flex-shrink-0">
                        {/* Viewport Container */}
