...
const WhyUsCard = ({ pillar, getDecorationStyle, currentIcons, isActive, domRef }: WhyUsCardProps) => {
    return (
        <div ref={domRef} className={`group ${isActive ? "is-active" : ""} relative isolate p-6 border border-background/10 rounded-lg hover:bg-background/10 group-[.is-active]:bg-background/10 hover:border-blue-400 group-[.is-active]:border-blue-400 hover:shadow-2xl hover:shadow-blue-500/10 group-[.is-active]:shadow-2xl group-[.is-active]:shadow-blue-500/10 transition-all duration-300 h-full overflow-hidden`}>
            ...
            <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-3 group-hover:text-blue-300 group-[.is-active]:text-blue-300 transition-colors text-background">{pillar.title}</h3>
                <p className="text-background/70 leading-relaxed text-sm group-hover:text-background group-[.is-active]:text-background transition-colors">
                    {pillar.desc}
                </p>
            </div>
        </div>
        ...
        <section className="py-10 bg-foreground text-background">
            <div className="container px-4 mx-auto">
                <AnimatedSection animation="fade-up" className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold font-heading text-background mb-6 leading-tight">
                        Why Leading Firms <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-sky-400">Choose SFL</span>
                    </h2>
                </AnimatedSection>
