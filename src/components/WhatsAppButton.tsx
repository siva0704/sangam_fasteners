...
const WhatsAppButton = () => {
    ...
    // Show button after a small delay or immediately, or only when scrolling
    // Usually WhatsApp button is always visible, but let's sync visibility with BackToTop if preferred
    useEffect(() => {
        // Reveal slightly after load for a nice effect
    ...
    const phoneNumber = "919343106083"; // Company phone without '+' or '-'
