...
const SectionBenchmarkMarquee = () => {
    ...
    return (
        <div className="w-full bg-card border-y-2 border-accent/50 overflow-hidden py-4 relative z-20 shadow-[0_4px_15px_rgba(59,130,246,0.1)] transition-colors duration-500">
            ...
            <div className="flex w-max">
                ...
                <div className="flex flex-nowrap animate-marquee items-center pe-8">
                    ...
                    <span className="text-foreground font-bold uppercase tracking-[0.2em] text-sm md:text-base whitespace-nowrap px-8">{text}</span>
                    <Target className="w-5 h-5 text-cyan-600 shrink-0" />
                </div>
