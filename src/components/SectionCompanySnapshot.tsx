    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-6 relative z-20 w-full">
                {/* Main Icon Container */}
                <div className={`shrink-0 p-4 rounded-2xl bg-secondary dark:bg-card/50 text-muted-foreground dark:text-slate-500 group-hover:bg-background dark:group-hover:bg-card group-hover:text-blue-600 dark:group-hover:text-blue-400 group-[.is-active]:bg-background dark:group-[.is-active]:bg-card group-[.is-active]:text-blue-600 dark:group-[.is-active]:text-blue-400 transition-all duration-300 shadow-sm group-hover:shadow-lg group-hover:shadow-blue-200/50 dark:group-hover:shadow-blue-900/50 group-[.is-active]:shadow-lg group-[.is-active]:shadow-blue-200/50 dark:group-[.is-active]:shadow-blue-900/50 ring-1 ring-border dark:ring-white/5 group-hover:ring-blue-100 dark:group-hover:ring-blue-500/20 group-[.is-active]:ring-blue-100 dark:group-[.is-active]:ring-blue-500/20 relative z-20`}>
                    <item.icon
                        size={32}
                        strokeWidth={1.5}
                ...
                <div className="flex flex-col items-start gap-1">
                    ...
                    <span className="inline-flex items-center gap-2 px-3 py-1 text-[10px] font-bold text-muted-foreground uppercase transition-all duration-500 group-hover:text-blue-700 dark:group-hover:text-blue-300 group-[.is-active]:text-blue-700 dark:group-[.is-active]:text-blue-300 rounded-full bg-secondary dark:bg-card/80 border border-border shadow-sm group-hover:border-blue-100 dark:group-hover:border-blue-500/30 group-[.is-active]:border-blue-100 dark:group-[.is-active]:border-blue-500/30 group-hover:bg-background dark:group-hover:bg-card group-[.is-active]:bg-background dark:group-[.is-active]:bg-card group-hover:shadow-sm group-[.is-active]:shadow-sm">
                        <span className="w-1.5 h-1.5 rounded-full bg-border dark:bg-slate-600 group-hover:bg-blue-500 group-[.is-active]:bg-blue-500 transition-all duration-500 shrink-0" />
