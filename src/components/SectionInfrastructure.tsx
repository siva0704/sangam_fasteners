                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-5 h-full flex flex-col justify-center">
                        <AnimatedSection animation="fade-right">
                            ...
                            <p className="text-lg text-slate-600 dark:text-muted-foreground mb-10 leading-relaxed font-light pr-4">
                            ...
                            <Link to="/about">
                                <MagneticButton size="lg" className="bg-background text-foreground hover:bg-card border-0">
